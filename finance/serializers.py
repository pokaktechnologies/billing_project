...
class CreditNoteSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        credit_note.create_or_update_journal_entry()  # ✅ Auto create journal
        return credit_note
    ...
    def update(self, instance, validated_data):
        ...
        instance.create_or_update_journal_entry()  # ✅ Auto update journal
        return instance
    def get_salesperson_name(self, obj):
        sp = obj.salesperson
        if sp:
...
class DebitNoteSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        debit_note.create_or_update_journal_entry()  # ✅ Auto-create Journal Entry
        return debit_note
    ...
    def update(self, instance, validated_data):
        ...
        instance.update_grand_total()
        instance.create_or_update_journal_entry()  # ✅ Auto-update Journal Entry
        return instance
...
# -------------------------------
# Main CashflowCategoryMapping Serializer
# -------------------------------
class CashflowCategoryMappingSerializer(serializers.ModelSerializer):
    ...
    # For GET: show full account info
    accounts = AccountBriefSerializer(many=True, read_only=True)

    # For POST/PATCH: accept only account IDs
